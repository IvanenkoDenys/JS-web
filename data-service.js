...
var sequelize = new Sequelize('demm87rkc60rvr', 'uncfywkuedspnn', '8ee0a5dbdc95c2afaa26eed60acf9bdeb3db9754b91a6cfd112387bb2fb89a21', {
...
//mongodb://<divanenko>:<123qwerty>@ds115352.mlab.com:15352/web322_a6
...
module.exports.initialize = function () {
    return new Promise(function (resolve, reject) {
        sequelize.sync().then( () => {
            ...
            reject("unable to sync the database"); // err here? 
        });
    });
}
