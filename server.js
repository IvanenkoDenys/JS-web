...
*
* Name: Denys Ivanenko Student ID: 132002155 Date: 02/12/2018
*
* Online (Heroku) Link: https://damp-savannah-44172.herokuapp.com
*
********************************************************************************/ 
...
const HTTP_PORT = process.env.PORT || 8079;
...
app.post("/login", (req,res) =>{
   ...
   // console.log(req.body.userName + "test2");
